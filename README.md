...
git clone https://github.com/logiclabs/dotnet-nuget-proxy-skill
...
- [Quick Start Guide](skills/nuget-proxy-troubleshooting/SKILL.md)
- [Detailed Proxy Documentation](skills/nuget-proxy-troubleshooting/files/NUGET-PROXY-README.md)
